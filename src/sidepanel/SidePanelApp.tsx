...
"overview" |"sessions" |"history"
 ...
 if (!authLoaded) {
 return (
 <div className="page-atmosphere flex min-h-full items-center justify-center p-6">
 ...
 return (
 <div className="page-atmosphere min-h-full w-full">
...
"w-fit border-transparent",
 ...
 variant="outline"
 size="sm"
 className="hover:border-emerald-400/70 hover:bg-background hover:text-foreground"
 ...
 variant="outline"
 className={cn(
 "hover:border-emerald-400/70 hover:bg-background hover:text-foreground",
 activeTab ==="overview" && "border-emerald-400/80"
 )}
 ...
 className={cn(
 "hover:border-emerald-400/70 hover:bg-background hover:text-foreground",
 activeTab ==="sessions" && "border-emerald-400/80"
 )}
 ...
 className={cn(
 "hover:border-emerald-400/70 hover:bg-background hover:text-foreground",
 activeTab ==="history" && "border-emerald-400/80"
 )}
 ...
 "appearance-none hover:border-emerald-400/70 hover:bg-background hover:text-foreground"
 )}
